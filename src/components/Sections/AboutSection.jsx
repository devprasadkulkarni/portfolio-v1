            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className=" ">
                    ...
                    <motion.div
                        ...
                        animate={isInView ? "visible" : "hidden"}
                        variants={containerVariants}
                        className="space-y-8 grid lg:grid-cols-2 gap-16 items-start"
                    >
                        <motion.div
                            variants={itemVariants}
                        ...
                        >
                            ...
                            >
                                I believe technology should be a bridge that
                                connects people and solves real-world problems.
                                My passion lies in crafting digital experiences
                                that are not just functional, but delightful and
                            ...
                            <div className="grid gap-4">
                                {PASSIONS.map((passion, index) => (
                                    <motion.div
                                        ...
                                        variants={itemVariants}
                                        whileHover={{ x: 4 }}
                                        className={`flex items-center space-x-4 rounded-xl transition-all duration-300 ${
                                            isDarkMode
